...
⚠️ **CRITICAL - Justifikasi Pemilihan Algoritma Lemah**
...
⚠️ **MODERATE - Scope Creep Potential**
...
### 2. Rumusan Masalah ⚠️ PERLU DIPERJELAS
...
### 1. Penelitian Terkait ✓ SANGAT BAIK

**Kekuatan:**
- 10 penelitian terkait dengan variasi yang baik (algoritma, metodologi, domain aplikasi)
- Setiap penelitian diringkas dengan struktur: algoritma → temuan → relevansi
...
### 2. Perbedaan dengan Penelitian Sebelumnya ✓ BAIK
...
### 3. Teori Pendukung ⚠️ BELUM LENGKAP (halaman terputus)
...
✓ Teori Quick Sort harus mencakup:
...
### 1. Tahapan Pelaksanaan Penelitian ✓ BAIK
...
### 3. Perancangan Data (ERD) ✓ SANGAT BAIK
...
### 4. Perancangan Proses ✓ SANGAT BAIK
...
✓ Ini menunjukkan mahasiswa memahami implementasi algoritma secara detail.

### 5. Perancangan Tampilan (Wireframe) ✓ BAIK

22 wireframe untuk berbagai role (Praktikan, Asisten, PJ) menunjukkan **perencanaan UI/UX yang matang**.

### 6. Perancangan Pengujian ✓ CUKUP BAIK
...
**⚠️ CRITICAL - Kurang Pengujian Performa Algoritma**
...
✓ Struktur sudah baik, tapi **perlu dipastikan isinya detail dan terukur**.
...
### 7. Waktu dan Tempat Penelitian ✓ BAIK
...
### 1. ⚠️ IMPLEMENTASI QUICK SORT - PERLU KLARIFIKASI
...
### 2. ⚠️ IMPLEMENTASI BINARY SEARCH - PERLU KLARIFIKASI

**Pertanyaan Kritis:**

```
Q1: Apa yang dicari dengan Binary Search?
    A. Praktikan berdasarkan NIM? → Database index sudah O(1) dengan PRIMARY KEY
    B. Praktikan berdasarkan nama? → LIKE query dengan index sudah cukup cepat
    C. Nilai dalam range tertentu? → Mungkin lebih relevan

Q2: Data dicari dari mana?
    A. Dari database langsung? → Index database lebih cepat
    B. Dari array yang sudah di-fetch? → Binary Search relevan di sini
    C. Dari cached data? → Binary Search sangat relevan
...
### 3. ✓ TEKNOLOGI STACK - SUDAH TEPAT

- **Backend:** PHP Laravel → Tepat, mature, well-documented
- **Frontend:** HTML/CSS/JavaScript → Standard dan sesuai
- **Database:** MySQL → Tepat untuk relational data
- **Server:** XAMPP → Sesuai untuk development
...
### 1. ⚠️ MISSING: Analisis Kompleksitas Algoritma yang Mendalam
...
- Prerequisite: Data HARUS terurut
  ...
  Total complexity: O(n log n) + O(log n) ≈ O(n log n)
...
### 2. ⚠️ MISSING: Baseline Comparison
...
### 3. ⚠️ MISSING: Threat to Validity
...
### 🔴 PRIORITY 1 - CRITICAL (Harus Diperbaiki Sebelum Sidang)
...
### 🟡 PRIORITY 2 - IMPORTANT (Disarankan Diperbaiki)
...
✅ **PROPOSAL LAYAK DILANJUTKAN** dengan perbaikan pada aspek-aspek kritis di atas.
...
### 1. Teori Pendukung (Lanjutan) ✓ BAIK
...
**⚠️ CRITICAL - Masih Kurang Depth:**
```
MISSING: Analisis matematis konkret
Contoh yang seharusnya ada:

Untuk Quick Sort O(n log n):
- n = 1000 data → ±10,000 operasi (1000 × log₂(1000) ≈ 1000 × 10)
- n = 10,000 data → ±133,000 operasi

Untuk Binary Search O(log n):
- n = 1000 data → maksimal 10 iterasi (2¹⁰ = 1024)
- n = 10,000 data → maksimal 14 iterasi (2¹⁴ = 16,384)
...
→ Ketika data sudah di-cache dan perlu multiple operations
→ Ketika perlu custom sorting logic yang complex
```

#### 2.2.4 Algoritma Sorting (Quick Sort) ✓ BAIK
**Kekuatan:**
...
✓ Ini adalah justifikasi yang kuat berdasarkan literatur.

#### 2.2.5 Algoritma Searching (Binary Search) ✓ BAIK
**Kekuatan:**
...
#### 2.2.6 Kombinasi Quick Sort dan Binary Search ✓ SANGAT BAIK
**Kekuatan:**
...
#### 2.2.7 Metodologi Pengembangan Sistem ✓ BAIK
**Kekuatan:**
...
### 2. Perancangan Sistem ✓ SANGAT BAIK
...
### 3. Perancangan Website ✓ SANGAT BAIK
...
#### 2.4.5 Framework Laravel ✓ SANGAT BAIK
**Kekuatan:**
- MVC architecture explained
- Eloquent ORM mentioned → relevant untuk sorting/searching
...
✓ **Ini adalah penjelasan konkret tentang WHERE algoritma akan digunakan!**
...
### 4. BAB III - METODOLOGI PENELITIAN ✓ SANGAT DETAIL

#### 3.1 Tahapan Pelaksanaan Penelitian ✓ SANGAT BAIK
...
✓ Jelas bahwa algoritma akan diimplementasikan di application layer
...
#### 3.3 Perancangan Data ✓ SANGAT BAIK (hal. 28-30)
...
- Proses: registrasi → lengkapi profil
...
#### 3.4 Perancangan Proses ✓ SANGAT LENGKAP
...
**Gambar 3.4.1 Use Case Sistem ✓**
- Visual diagram included
- Relationships clear (include, extend if any)
- System boundary defined

**3.4.2 DFD Level 0 ✓ BAIK**
...
✓ Ini menunjukkan pemahaman tentang centralized system architecture
...
✓ Ini mengindikasikan flowchart algoritma akan ada (confirmed di halaman selanjutnya)

**3.4.4 Flowchart Praktikan ✓ BAIK**

**Alur Explained:**
1. Akses website
2. Sistem tampilkan homepage
3. Decision: punya akun?
   - Ya → login (email + password) → validasi
     - Berhasil → beranda → menu (materi, data diri)
     - Gagal → ulang login
   - Tidak → halaman pendaftaran → registrasi → login
4. Beranda: access various menus
5. Logout

**Gambar 3.4.4 Flowchart Praktikan ✓**
- Visual flowchart with standard symbols
- Decision points (diamond) clear
- Flow logical

**3.4.5 Flowchart Asisten** (terpotong di hal. 36-37)
- Alur dimulai: akses website → login → validasi
...
✓ Ini menjawab pertanyaan "Di mana algoritma diimplementasikan?" → **Di Laravel Controller (application layer)**
...
✓ Flowchart algoritma ADA, tapi ada di halaman selanjutnya (belum ter-audit)
...
→ "Fitur pencarian menggunakan Binary Search pada data yang telah
   diurutkan dengan Quick Sort"
```

#### 3.4.6 Flowchart PJ Praktikum ✓ BAIK
**Kekuatan:**
...
#### 3.4.7 Flowchart Proses Penilaian dan Presensi ✓ BAIK
**Kekuatan:**
...
**⚠️ CRITICAL - MISSING LINK KE ALGORITMA:**
```
...
[Sistem menerima data array yang sudah terurut...]
    ↓
[Proses pencarian] → {Apakah Asisten ingin mencari praktikan?}
    Ya → [Proses Binary Search (Lihat Flowchart 3.4.9)]
```

#### 3.4.8 Flowchart Proses Manajemen Data ✓ BAIK
**Kekuatan:**
...
#### 3.4.9 Flowchart Proses Pencarian Binary Search ✓✓ SANGAT BAIK
**Kekuatan:**
...
✓✓ Ini menunjukkan mahasiswa MEMAHAMI bahwa Binary Search memerlukan **prerequisite data terurut**

**⚠️ MINOR - Potensi Perbaikan:**
```
TYPO di flowchart:
- Mid = (L + H)/2 → seharusnya Mid = (L + R)/2
  (H biasanya notasi untuk "High", tapi di flowchart sebelumnya menggunakan R untuk "Right")

KONSISTENSI: Pilih satu notasi:
- L dan R (Left & Right) → lebih umum di literatur
- atau L dan H (Low & High) → juga valid
...
#### 3.4.10 Flowchart Quick Sort ✓✓ SANGAT BAIK
**Kekuatan:**
...
#### 3.4.11 Flowchart Pemilihan Pivot MO7 ✓✓ SANGAT BAIK
**Kekuatan:**
- **Implementasi Median of Seven dijelaskan dengan detail**
- Logika kondisional:
  - Jika data < 7 elemen → pilih elemen tengah sebagai pivot (fallback sederhana)
  - Jika data ≥ 7 elemen → ambil 7 kandidat dari posisi:
...
**⚠️ MINOR - Perlu Klarifikasi Matematis:**
```
...
**⚠️ MODERATE - Proses "Menentukan median dari 7 nilai":**
```
...
#### 3.4.12 Flowchart Partition Quick Sort ✓ BAIK
**Kekuatan:**
...
- Langkah-langkah:
  ...
  3. Loop: Apakah data ke-i < pivot?
     - Ya → Pindahkan ke kiri pivot
     - Tidak → Data tetap di kanan
  4. Naikkan indeks i (i = i + 1)
  5. Ulangi sampai i ≤ H
  6. Sistem menempatkan pivot pada posisi yang benar
  7. Return posisi pivot

**⚠️ MODERATE - Implementasi Partition Scheme:**
```
Dari flowchart, terlihat menggunakan skema:
"Apakah data ke-i < pivot? → Pindahkan ke sisi kiri pivot"
...
"Partition menggunakan Lomuto scheme dengan single pointer traversal,
 memisahkan elemen ≤ pivot ke sisi kiri dan > pivot ke sisi kanan"
```
...
#### Penjelasan Umum Perancangan Tampilan ✓ BAIK
**Kekuatan:**
...
#### 3.5.1 - 3.5.3 Halaman Autentikasi (Masuk, Daftar, Beranda) ✓ BAIK
**Kekuatan:**
...
#### 3.5.4 - 3.5.6 Wireframe Praktikan ✓ SANGAT BAIK
**Kekuatan:**
- Beranda menampilkan:
  - Nilai akhir
...
**⚠️ MINOR - Fitur Pencarian Materi:**
```
...
#### 3.5.7 - 3.5.11 Wireframe Asisten ✓ SANGAT BAIK
**Kekuatan:**
...
1. PRESENSI (Gambar 3.5.8):
   ...
   → Data praktikan diurutkan berdasarkan kriteria (NIM/Nama)
   → Binary Search saat Asisten mengetik di search field

2. PENILAIAN PRETEST/POSTTEST (Gambar 3.5.10):
   - Field: "Cari Praktikan Berdasarkan Urutan Sekarang"
   - Action: "Tampilkan Berdasarkan Test"
   → Data diurutkan berdasarkan NIM atau nama
   → Binary Search untuk menemukan praktikan tertentu
...
#### 3.5.12 - 3.5.20 Wireframe PJ Praktikum ✓✓ SANGAT KOMPREHENSIF
**Kekuatan:**
- Beranda PJ:
...
1. **Flowchart Algoritma SANGAT DETAIL dan BENAR** ✓✓
...
2. **Integrasi Algoritma ke Fitur Sistem JELAS** ✓✓
...
3. **Wireframe Komprehensif dan User-Centered** ✓
...
1. **Detail Teknis Perhitungan Median MO7 Belum Dijelaskan** ⚠️
...
2. **Partition Scheme Tidak Dispesifikasikan** ⚠️
   - Apakah Lomuto atau Hoare partition?
   - Penting untuk dokumentasi dan implementasi

3. **Evaluasi Kinerja Algoritma Belum Terlihat** ⚠️⚠️
...
4. **Typo Minor di Flowchart** ⚠️
   - Mid = (L + H)/2 vs Mid = (L + R)/2 → perlu konsistensi notasi
...
**PRIORITY 1 (Critical):**
1. ✓ Flowchart algoritma sudah SANGAT BAIK - tidak perlu perubahan besar
2. ⚠️ Tambahkan sub-flowchart atau pseudocode untuk "Menentukan Median dari 7 Nilai"
3. ⚠️ Spesifikasikan partition scheme (Lomuto/Hoare) di caption

**PRIORITY 2 (Important):**
4. ⚠️ Perbaiki typo/inkonsistensi notasi (H vs R untuk Right/High)
5. ⚠️ Tambahkan keterangan teknis di wireframe yang memiliki fitur pencarian:
   ```
...
#### 3.6.1 - 3.6.7 Pengujian Fungsional (Black-Box Testing) ✓ SANGAT BAIK
...
**⚠️ MINOR - Catatan Kecil:**
```
1. Semua hasil pengujian tercantum "Sesuai" → ini berarti proposal ini
...
2. MISSING: Test case untuk fitur pencarian (Binary Search)
   ...
   - "Cari materi" → Materi tersaring (Sesuai)
...
**⚠️ MODERATE - Missing: Pengujian Non-Fungsional**
```
...
### Analisis Sub-bab 3.7: **Evaluasi Kinerja Algoritma** ✓✓ SANGAT BAIK
...
#### 3.7.2 Parameter Evaluasi ✓✓ SANGAT BAIK
**Kekuatan:**
...
**Catatan Positif:**
✓✓ Ini adalah parameter standar untuk evaluasi algoritma dalam konteks sistem berbasis web.
...
**⚠️ CRITICAL - MISSING BASELINE COMPARISON:**
```
...
#### 3.7.3 Dataset dan Variasi Ukuran Data ✓✓ SANGAT BAIK
**Kekuatan:**
- **3 variasi dataset:** 100, 500, 1000 data praktikan ✓
- **Data source jelas:** database MySQL sistem praktikum ✓
- **Initial condition specified:** data dalam kondisi tidak terurut ✓

**Catatan Positif:**
✓ Variasi dataset sesuai dengan rumusan masalah di Bab 1.
✓ Kondisi data "tidak terurut" memastikan pengujian worst-case scenario.

**⚠️ MODERATE - Dataset Realism:**
```
...
#### 3.7.4 Skenario dan Prosedur Pengujian ✓ BAIK
**Kekuatan:**
...
- **Pengulangan: 10 kali per dataset** → untuk stabilitas hasil ✓
- **Hasil dirata-ratakan** → mengurangi bias ✓

**Catatan Positif:**
✓ Prosedur scientific method yang baik (repetition + averaging)

**⚠️ MODERATE - Missing Details:**
```
...
**Kekuatan:**
- **Waktu eksekusi:** mencatat waktu sebelum & sesudah, hitung selisih ✓
- **Penggunaan memori:** konsumsi memori sistem during processing ✓
- **Latensi respons:** waktu permintaan → hasil ditampilkan ✓
- **Averaging:** data dirata-ratakan untuk analisis ✓

**⚠️ CRITICAL - Missing Implementation Details:**
```
...
#### 3.7.6 Lingkungan Pengujian ⚠️⚠️ CRITICAL ISSUE
**Masalah BESAR:**
```
...
#### 3.7.7 Analisis Hasil Evaluasi ✓ CUKUP BAIK
**Kekuatan:**
- Metode analisis: **deskriptif kuantitatif** ✓
- Perbandingan nilai rata-rata pada setiap variasi dataset ✓
- Tujuan jelas: mengetahui kecenderungan perubahan kinerja ✓

**⚠️ MODERATE - Perlu Lebih Detail:**
```
...
**⚠️⚠️ CRITICAL - PLACEHOLDER TEXT:**
```
Halaman 74 masih berisi PLACEHOLDER:

"Penelitian ini akan dilaksanakan pada bulan …… sampai bulan ……. tahun ….."
"Adapun tempat pelaksanaan penelitian dilakukan di Instansi/Lembaga/Perusahaan
 …………………."
"sedangkan analisis data dilakukan pada Laboratorium ……………"
...
### Analisis Daftar Pustaka ✓✓ SANGAT BAIK

**Kekuatan:**
- **Total referensi: 27** (memenuhi requirement 30-50) ✓
- **Tahun publikasi: 2020-2025** (5 tahun terakhir) ✓
- **Jurnal/prosiding:**
...
1. **Tahsin et al. (2024)** - Median of Seven pivot selection → CORE REFERENCE
...
**⚠️ MODERATE - Missing Reference Types:**
```
Dari 27 referensi, SEMUA adalah artikel jurnal/prosiding.

Sesuai requirement:
- Artikel jurnal/prosiding: 60% → SUDAH TERPENUHI (100%)
- Buku/Chapter Book: 30% → TIDAK ADA (0%)
- Web: 10% → TIDAK ADA (0%)
...
```
1. Ada duplikasi: Aleryani (2024a) dan Aleryani (2024b) → SAMA PERSIS
   REKOMENDASI: Hapus salah satu

2. Smrti et al. (2023a) dan Smrti et al. (2023b) → SAMA PERSIS
   REKOMENDASI: Hapus salah satu
...
|---------------------------------|--------|--------|--------------|
| Jurnal/prosiding (5 tahun)      | 60%    | 100%   | ✓ Terpenuhi  |
| Buku (5 tahun)                  | 30%    | 0%     | ✗ Kurang     |
| Web                             | 10%    | 0%     | ✗ Kurang     |
| Total referensi                 | 30-50  | 27     | ⚠️ Hampir    |
| Software Management Reference   | Wajib  | Ya     | ✓ Terpenuhi  |
```
...
3. **Daftar Pustaka RELEVAN dan UP-TO-DATE** ✓
...
1. ⚠️⚠️ **FIX Sub-bab 3.7.6** - Ganti dengan spesifikasi lingkungan pengujian SEBENARNYA
2. ⚠️⚠️ **ISI Placeholder** - Waktu, tempat, dan jadwal penelitian
3. ⚠️⚠️ **TAMBAH Baseline Comparison** - Bandingkan dengan SQL ORDER BY + WHERE/LIKE

**PRIORITY 2 (Important - SHOULD FIX):**
4. ⚠️ **TAMBAH Test Case Binary Search** - Test case spesifik untuk algoritma
5. ⚠️ **DIVERSIFIKASI Daftar Pustaka** - Tambah 8-10 buku + 2-3 web references
6. ⚠️ **DETAILKAN Teknik Pengukuran** - Spesifikasi tool/fungsi yang digunakan
...
**Status Audit:** ✓✓ SELESAI (Halaman 1-94 Sudah Diaudit Lengkap)
